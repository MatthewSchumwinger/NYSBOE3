...
Criteria:  
 ...
 1) **The recipient is a county committee or party committee**  (Committe Type = "3","3H", "6", "6H")
...
- **`r formatC(nrow(cmtes), big.mark=",") `** filers classed as CONSTITUTED COUNTY or PARTY STATE or associated housekeeping.
- **`r formatC(nrow(trans1), big.mark=",") `** transactions matching such entities.
